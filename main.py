...
async def inline_handlers(_, event: Message):
    ...
    try:
        ...
        logging.info(f"[{Config.BOT_SESSION_NAME}] - Answered Successfully - {event.from_user.first_name}")
        await asyncio.sleep(30)
        await msg.delete()
    except:
        logging.info(f"[{Config.BOT_SESSION_NAME}] - Failed to Answer - {event.from_user.first_name}")
